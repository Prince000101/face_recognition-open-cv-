...
### Overview
The repo module handles all repo operations. It integrates with the core pipeline and provides extensible hooks for customization.

### Usage
```python
from src.docs import RepoManager
...
### Overview
The query module handles all query operations. It integrates with the core pipeline and provides extensible hooks for customization.

### Usage
```python
from src.docs import QueryManager
