...
### Usage
```python
from src.ci import RouteManager
...
### Overview
The register module handles all register operations. It integrates with the core pipeline and provides extensible hooks for customization.

### Usage
```python
from src.ci import RegisterManager
...
### Usage
```python
from src.ci import DecoratorsManager
...
### Usage
```python
from src.ci import CacheManager
